\begin{figure}
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot[mark=*, mark repeat=2, red]
      coordinates {
(1,0.000001)
(2,0.000002)
(3,0.000008)
...
(5,0.000290)
      ...
      \addplot[mark=square, mark repeat=2, blue]
      coordinates {
(1,0.000002)
(2,0.000004)
(3,0.000006)
...
(11,0.163843)
      ...
      \addplot[mark=pentagon, mark repeat=2, teal]
      coordinates {
(1,0.000014)
(2,0.000043)
(3,0.000082)
...
(30,0.014788)
      ...
      \addplot[mark=triangle, mark repeat=2, purple]
      coordinates {
(1,0.000148)
(2,0.000183)
(3,0.000535)
...
(30,0.210087)
      ...
      \addplot[mark=diamond, mark repeat=2, brown]
      coordinates {
(1,0.000003)
(2,0.000004)
(3,0.000009)
...
(30,0.0)
  ...
  \caption{Log plots of the average running times for verifying 10000 random puzzles of widths
    ...
    and that the axes are named only on the edges of the page.  Each plot
