...
\begin{myframe}{Verification}
  ...
  \begin{problem}[SUSP-Verification]
...
\begin{myframe}{Strong USP Found -- Trends and Comparison}
  ...
  \begin{tabular}{|c|r|r|r|r|}
    ...
    \hline
    Width & Height & $\omega^*$~ & Height & $\omega^*$~\\
    \hline
    1 & $\le 1$ & & $1=$ & 3.000 \\
    2 & $\le 3$ & & $2=$ & 2.670 \\
    ...
    4 & $\le 12$ & & $5=$ & 2.585 \\
    5 & $\le 24$ & & $8=$ & 2.562 \\
    6 & $\alert{10} \ldots 45$ & \alert{2.615} &$\alert{14}\le$ & \alert{2.521}\\
    7 & $\le 86$ & & $21\le$ & 2.531\\
    8 & $\le 162$ & & $30\le$ & 2.547 \\
    9 & $36 \ldots 307$ & 2.592 &$42\le$ & 2.563 \\
    10 & $\le 581$ & & $64\le$ & 2.562 \\
    11 & $\le 1098$ & & $112\le$ & 2.540 \\
    12 & $136 \ldots 2075$ & 2.573 &$196\le$ & 2.521 \\
    \hline
  \end{tabular}
  \end{center}
