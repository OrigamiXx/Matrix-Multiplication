...
sufficiently large strong USP that imply a faster matrix
...
result of form (i), and are not guaranteed to be tight.
...
\begin{figure}
  ...
  \end{multicols}
  \vspace{-3ex}
  \caption{Respresentative examples of maximum-size strong USP found from width $k = 1$ to $6$.}
  \label{fig:examples}
\end{figure}

We begin with a diagram, \autoref{fig:examples}, of representative
examples of maximal strong USP we found for $k \le 6$.  For space, we
...
in constructing the reduced instance and running the third party tool.
...
becomes faster.  The hybrid algorithm generally performs best or close
to best.  Notice that it match the dynamic programming algorithm
