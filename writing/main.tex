...
\subsubsection{Verification to 3D Matching}
...
\set{0, 1}$, (ii) as an order three tensor $f_p \in \set{0,1}^{P \times P
  \times P}$, and (iii) as the complement of the characteristic
function of hyperedge relations of a tripartite hypergraph $H_P =
\langle P \sqcup P \sqcup P, \bar{f_p}\rangle$ where the vertex set is the
disjoint union of three copies of $P$.
...
\begin{proof}
  ...
  $e(r)$ having non identical coordinates.
\end{proof}
