...
OBJ-SOURCES=checker.c permutation.c puzzle.c set.c matching.c 3DM_to_SAT.c timing.c heuristic.c construct.c searcher.c clique_to_mip.c canonization.c
# Put additional executable sources in list below.
TESTER-SOURCES=test_3DM_to_SAT.c test_permutation.c test_puzzle.c test_set.c test_matching.c test_scratch.c search_heuristic_tester.c test_canonization.c test_graph.c
